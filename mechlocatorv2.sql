...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2022 at 03:23 PM
...
(18, '-1.3800709', '36.7672312', 'RONGAI'),
(23, '-1.3983368', '36.7640138', 'rongai');
...
('kcz 223a', 'oil change', 8000, '2022-03-13', 95, 'YES', 0),
('kcz 223a', '', 0, '2022-03-13', 96, 'YES', 0),
('KBB 509B', '', 0, '2022-03-22', 97, 'YES', 0),
('KBB 509B', 'OIL CHANGE', 200, '2022-03-22', 98, 'YES', 0),
('KBB 509B', '', 0, '2022-03-22', 99, 'YES', 0);
...
('John Doe', 'pollandsabisa@gmail.com', '072989392', '$2y$10$pcInJwL/gRnwzj4Lz7sgZupHGMxEGc0lLZRtXxzEUzF2QxYDBzChG', 'YES', 18, 'YES'),
('POLLAND ONDERI', 'POPO@GMAIL.OM', '0795836437', '$2y$10$57FTrssL4kaznQr3gSOo/OrxxUrVcaEIxGQF1Xq6vdzUTwz7c8GWO', 'NO', 19, 'YES'),
('gloria kerubo', 'gloria@gmail.com', '0723477853', '$2y$10$d498O2AJnqdfVZGo0JtDQeYaPS8u/X5FojjSzO5W4.KtwTipvCpLm', 'NO', 20, 'YES'),
('eunice wachirra', 'eunice@email.com', '0797080970', '$2y$10$fD8sic1s7bQgD1oCtetCLeVysEtabvofirZut81Cg3/XWd3bg12aK', 'NO', 21, 'YES'),
('POLLAND ONDERI', 'polland@gmail.com', '12345678', '$2y$10$ZBxomce9/gXcM1u.a.LU9eXyu2weGqiEY16ws1ZyCeLoI4QKvK7Lu', 'YES', 23, 'NO');
...
--
ALTER TABLE `repairs`
  MODIFY `repair_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
